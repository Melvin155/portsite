...
const MobileMenuLinks = styled(LinkS)`
  color: ${({ theme }) => theme.text_primary};
  font-weight: 500;
  cursor: pointer;
  transition: all 0.2s ease-in-out;
...
const Navbar = () => {
    ...
    <Nav>
        ...
        <NavItems>
          ...
          <NavLink to="education" smooth={true} duration={500} offset={-80}>Education</NavLink>
          <NavLink to="courses" smooth={true} duration={500} offset={-80} style={{ whiteSpace: "nowrap" }}>
            Relevant Courses
          </NavLink>
</NavItems>
...
>
  Relevant Courses
            ...
            <GithubButton style={{
                ...
                href="https://github.com/Melvin155" 
                target="_blank"
                >
                    Github Profile
                    </GithubButton>
